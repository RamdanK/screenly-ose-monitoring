  ...
  <div class="container-fluid">
    ...
    if(hasPlayerAddRight($loginUserID)) echo'
      ...
      <div class="nav-item d-none d-md-flex mr-3">
        <a href="index.php?site=settings&view=system" class="nav-link px-0" tabindex="-1" title="Debug Mode is activated">
    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
      <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
        <ul class="navbar-nav">
          ...
          ';
          echo '
          <li class="nav-item'.(isset($_GET['site']) && $_GET['site'] == 'assets' ? $nav_active : '').'">
              <a class="nav-link" href="index.php?site=assets">
